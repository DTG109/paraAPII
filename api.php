<?
// Usamos el puerto asignado por Railway
$port = $_ENV['PORT'] ?? 8080;  // Si no está configurado, usa 8080 por defecto
$server = "0.0.0.0";  // Asegúrate de que el servidor escuche en todas las interfaces
